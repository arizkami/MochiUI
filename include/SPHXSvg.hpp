...
// SPHXSvg — SVG document loading and rendering via Skia's SVGDOM.
...
//
//   auto logo = SPHXSvg::fromFile("assets/logo.svg");
//   auto icon = SPHXSvg::fromResource("res://play.svg");
//
...
private:
    ...
    explicit SPHXSvg(std::shared_ptr<Impl> impl) : _impl(std::move(impl)) {}
};
